...
// ═══════════════════════════════════════════════════════════════════════
// ⚙️ Config Database (for admin log channel)
// ═══════════════════════════════════════════════════════════════════════

class ConfigDatabase {
    constructor() {
        this.data = loadJSON(CONFIG_FILE, {});
    }

    _save() {
        saveJSON(CONFIG_FILE, this.data);
    }

    getLogChannel(guildId) {
        return this.data[guildId]?.logChannel || null;
    }

    setLogChannel(guildId, channelId) {
        if (!this.data[guildId]) this.data[guildId] = {};
        this.data[guildId].logChannel = channelId;
        this._save();
    }
}
